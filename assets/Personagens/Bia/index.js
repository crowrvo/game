export default class PlayerBia {
  constructor(width, height, x, y, scale, speed, canvas,context, mapa) {
    this.width = width;
    this.height = height;
    this.spriteWidth = 19;
    ...
    addEventListener("keydown", (e) => {
      if (this.acceptableKey[e.code] != undefined) if (!this.keys.includes(e.code)) this.keys.unshift(e.code);
    });
  ...
  draw() {
    ...
    this.context.fillText(`Absolute Pos: X: ${this.x} | Y: ${this.y}`, 128, 128);
